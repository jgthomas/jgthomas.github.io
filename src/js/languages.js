...
const web = {
  ...
  <span class="language-name">${langs.webTech}</span> really opened up 'API thinking' for me, as a complement to the 'algorithmic thinking' of much of my previous explorations.
